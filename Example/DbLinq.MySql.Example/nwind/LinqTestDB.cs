//#########################################################################
//generated by MysqlMetal on 2007-Oct-31 - extracted from file my_s.dbml.
//#########################################################################
...
namespace nwind
{
	...
	public partial class LinqTestDB : MContext
	{
		...
		public LinqTestDB(System.Data.IDbConnection connection) : base(connection)
		{
			Alltypes = new MTable<Alltype>(this);
			Categories = new MTable<Category>(this);
			Customers = new MTable<Customer>(this);
	...
	public partial class Employee : IModified
	{
		...
		public Employee(int EmployeeID,string LastName,string FirstName,string Title,DateTime? BirthDate,DateTime? HireDate,string Address,string City,string Region,string PostalCode,string Country,string HomePhone,int? ReportsTo)
		{
